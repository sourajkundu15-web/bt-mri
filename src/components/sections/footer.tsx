...
export function Footer() {
  return (
    <footer className="mt-auto relative border-t border-coral/15 glass-strong">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <span className="grid place-items-center w-9 h-9 rounded-lg bg-coral/15 border border-coral/40">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={s.label}>
                  <span className="flex items-center gap-2.5 text-muted-foreground hover:text-coral transition-colors cursor-default">
            ...
            <div className="flex flex-wrap gap-2">
              {["TensorFlow", "Keras", "VGG19", "scikit-learn", "Matplotlib", "Next.js", "Three.js"].map(
                (t) => (
                  <span
                    key={t}
                    className="px-2.5 py-1 rounded-md text-[11px] font-mono bg-coral/8 border border-coral/20 text-muted-foreground"
                  >
                    {t}
                  </span>
                )
        ...
        <div className="mt-10 pt-6 border-t border-coral/10 flex flex-col sm:flex-row items-center justify-between gap-3">
